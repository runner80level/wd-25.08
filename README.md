    ...
    <style>
        ...
        * {
        ...
        #map {
            width: 100%;
            height: 100%;
            filter: grayscale(50%) invert(90%) contrast(110%);
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function init() {
                const map = new ymaps.Map('map', {
                    center: [55.7515, 38.2066], // Координаты Кратово (примерные)
                    zoom: 15,
                    controls: ['zoomControl']
                });
                
                // Метка с адресом
                const placemark = new ymaps.Placemark([55.7515, 38.2066], {
                    hintContent: 'Кратово, Тверская 5/17',
                    balloonContent: 'Место проведения свадьбы'
                }, {
                    iconLayout: 'default#image',
                    iconImageHref: 'https://maps.yandex.ru/static/i/v4/pin_2.png',
                    iconImageSize: [32, 40],
